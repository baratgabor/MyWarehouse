...
{
    public class RecordProcurementCommandValidator : AbstractValidator<RecordProcurementCommand>
    {
        private readonly IProductRepository _productRepository;

        public RecordProcurementCommandValidator(IProductRepository productRepository)
        {
        ...
        private async Task<bool> HaveSufficientStock(RecordProcurementCommand c, RecordProcurementCommand.TransactionLine[] lines, PropertyValidatorContext ctx, CancellationToken _)
        {

...
namespace MyWarehouse.Application.Transactions.RecordProcurement
{
    public record RecordProcurementCommand : IRequest<int>
    {
        ...
        public struct TransactionLine
        {
            ...
            public decimal ProductPurchaseUnitPriceAmount { get; init; }
            public string ProductPurchaseUnitPriceCurrencyCode { get; init; }
        }
    }

    public class CreateTransactionCommandHandler : IRequestHandler<RecordProcurementCommand, int>
    {
        ...
        public async Task<int> Handle(RecordProcurementCommand request, CancellationToken cancellationToken)
        {
